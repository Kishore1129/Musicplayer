const songData = [
  {
    songName: "Velichapoove",
    song: "./Music/velichapoove.mp3",
    songImg: "./asset/velichapoove.jpg",
    songAuthour: "Mohit & shreya",
  },
  {
    songName: "HeatWaves",
    song: "./Music/heatwaves.mp3",
    songImg: "./asset/heatwaves.jpg",
    songAuthour: "Glass Animals",
  },
  {
    songName: "Summertimesadness",
    song: "./Music/Summersadness.mp3",
    songImg: "./asset/sadness.jpg",
    songAuthour: "Lana del rey",
  },
];
